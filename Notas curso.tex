...
\begin{description}
	\item[Modus Ponens] % TODO: terminar ésta regla, y el resto. Deben incluir nombre, símbología y tabular, intuición, demostración y ejemplo de uso. 
		...
		La ecuación \ref{eq_inferenciaMP}, al igual que toda regla de inferencia que veremos más abajo, se puede escribir de manera \emph{tabular} que facilita la lectura:
			% TODO: tabular
